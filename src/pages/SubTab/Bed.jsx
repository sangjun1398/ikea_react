...
import bathData from '../../components/Data/bedData'
import '../../css/SubTab/bed.css'
  ...
  return (
    <div className='bath_container'>
        ...
        bathData.map((value, i) => {
            return(
            <div className='bed' key={value.id}>
                <Link to='/detail'>
                    <div className="bed_img">
                        <img src={`/img/sub/bed${i+1}.png`} alt={`bed${i+1}`} />
                    </div>
                    <div className="bed_text">
                        ...
                        <p className="bed_name">{value.name}</p>
                        <p className="bed_desc">{value.desc}</p>
                        <p className="bed_price">{value.price}</p>
                    </div>
                </Link>
            </div>
            )
