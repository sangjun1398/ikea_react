...
import lightData from '../../components/Data/lightData'
import '../../css/SubTab/light.css'
...
export default function Light() {
  return (
    <div className='light_container'>        
        ...
        {
        lightData.map((value, i) => {
            return(
            <div className='light' key={value.id}>
                <Link to='/detail'>
                    <div className="light_img">
                        <img src={`/img/sub/light${i+1}.png`} alt={`light${i+1}`} />
                    </div>
                    <div className="light_text">
                        ...
                        <p className="light_name">{value.name}</p>
                        <p className="light_desc">{value.desc}</p>
                        <p className="light_price">{value.price}</p>
                    </div>
                </Link>
            </div>
            )
