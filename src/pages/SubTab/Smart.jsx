...
import outdoorData from '../../components/Data/smartData'
import '../../css/SubTab/smart.css'
  ...
  return (
    <div className='smart_container'>
        ...
        outdoorData.map((value, i) => {
            return(
            <div className='smart' key={value.id}>
                <Nav.Link onClick={() => {navigate('/detail')}}>
                    <div className="smart_img">
                        <img src={`/img/sub/smart${i+1}.png`} alt={`smart${i+1}`} />
                    </div>
                    <div className="smart_text">
                        ...
                        <p className="smart_name">{value.name}</p>
                        <p className="smart_desc">{value.desc}</p>
                        <p className="smart_price">{value.price}</p>
                    </div>
                </Nav.Link>
            </div>
            )
