...
import bathData from '../../components/Data/bathData'
import '../../css/SubTab/bath.css'
...
export default function Bath() {
  return (
    <div className='bath_container'>
        ...
        bathData.map((value, i) => {
            return(
            <div className='bath' key={value.id}>
                <Link to='/detail'>
                    <div className="bath_img">
                        <img src={`/img/sub/bath${i+1}.png`} alt={`bath${i+1}`} />
                    </div>
                    <div className="bath_text">
                        ...
                        <p className="bath_name">{value.name}</p>
                        <p className="bath_desc">{value.desc}</p>
                        <p className="bath_price">{value.price}</p>
                    </div>
                </Link>
            </div>
            )
