...
import outdoorData from '../../components/Data/outdoorData'
import '../../css/SubTab/outdoor.css'
...
export default function Outdoor() {
  ...
  return (
    <div className='outdoor_container'>        
        ...
        {
        outdoorData.map((value, i) => {
            return(
            <div className='outdoor' key={value.id}>
                <Nav.Link onClick={() => {navigate('/detail')}}>
                    <div className="outdoor_img">
                        <img src={`/img/sub/outdoor${i+1}.png`} alt={`outdoor${i+1}`} />
                    </div>
                    <div className="outdoor_text">
                        ...
                        <p className="outdoor_name">{value.name}</p>
                        <p className="outdoor_desc">{value.desc}</p>
                        <p className="outdoor_price">{value.price}</p>
                    </div>
                </Nav.Link>
            </div>
            )
